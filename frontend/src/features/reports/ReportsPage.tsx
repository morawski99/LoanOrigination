    ...
    <div className="min-h-screen bg-neutral-100">
      ...
      <main className="page-container py-8" id="main-content">
        ...
        <p className="text-neutral-600">
          Generate and export reports for pipeline analysis, HMDA compliance,
          production metrics, and regulatory submissions.
        </p>
        <div className="mt-8 card p-12 flex flex-col items-center justify-center text-center">
          <div className="w-16 h-16 rounded-full bg-primary-100 flex items-center justify-center mb-4">
            <FileText className="w-7 h-7 text-primary-600" aria-hidden="true" />
          </div>
          <p className="text-lg font-semibold text-neutral-700">
            Reports Module
          </p>
          <p className="text-sm text-neutral-500 mt-1 max-w-md">
            HMDA LAR reporting, pipeline reports, production dashboards,
            and compliance exports will be available here.
          </p>
        </div>
      </main>
    </div>
